...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Rs4sHI3dzDQqHTjX',  # 数据库用户密码
        'NAME': 'meiduomall_db'  # 数据库名字
    }
}
...
# 使用我的 163服务器 和 授权码
#发送邮件的邮箱
EMAIL_HOST_USER = 'zhuche99@126.com'
#在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'OCQYMKKMMOGZPEPK'
...
# 默认文件存储
DEFAULT_FILE_STORAG = 'utils.fastdfs.storage.MyStorage'
